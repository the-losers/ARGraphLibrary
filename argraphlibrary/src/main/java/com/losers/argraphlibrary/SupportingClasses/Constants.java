...
public class Constants {
  ...
  public static Float graphScaleFactor = 0.1f;

  public static Float graphTotalLength = 2.0f;

  public static Float cubeWidth = 0.01f;

  public static Float cubeLength = 0.5f;
